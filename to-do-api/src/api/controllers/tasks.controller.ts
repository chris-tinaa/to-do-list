...
import { TasksService, DeadlineSortOptions } from '../../services/tasks.service';
import { CreateTaskInput, UpdateTaskInput } from '../../models/task.model';
import { TaskQueryOptions } from '../../repositories/interfaces/tasks.repository.interface';
...
export class TasksController {
   ...
   */
  async getListTasks(req: AuthRequest, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   * @param next - Express next function
   */
  async markTaskComplete(req: AuthRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      const userId = req.userId;
      const taskId = req.params.id;
   ...
   * @param next - Express next function
   */
  async markTaskIncomplete(req: AuthRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      const userId = req.userId;
      const taskId = req.params.id;
   ...
   * @param next - Express next function
   */
  async getTasksDueThisWeek(req: AuthRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      const userId = req.userId;
   ...
   * @param next - Express next function
   */
  async getTasksSortedByDeadline(req: AuthRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      const userId = req.userId;
      ...
      const options: DeadlineSortOptions = {
   ...
   * @private
   */
  private parseTaskQueryOptions(query: any): TaskQueryOptions | undefined {
 ...
 */
export function createTasksController(tasksService: TasksService): TasksController {
